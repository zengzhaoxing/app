...
public class DatePickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public DatePickerDialog create() {
            ...
            View view1 = View.inflate(context,R.layout.layout_picker_date,null);

            Calendar c = Calendar.getInstance();

            final LoopView loopDay = (LoopView) view1.findViewById(R.id.loop_day);
            ...
            final LoopView loopYear = (LoopView) view1.findViewById(R.id.loop_year);
            ...
            final LoopView loopMonth = (LoopView) view1.findViewById(R.id.loop_month);
